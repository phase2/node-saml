...
var saml20 = fs.readFileSync(path.join(__dirname, 'saml20-original.template')).toString();
...
Object.keys(options.attributes).forEach(function(prop) {
  ...
  values.forEach(function (value) {
    ...
    if (typeof value !== 'undefined') {
      ...
      if (getAttributeType(value) === 'object'){
        valueDoc = new Parser().parseFromString(value.toString());
        valueElement.appendChild(valueDoc);
